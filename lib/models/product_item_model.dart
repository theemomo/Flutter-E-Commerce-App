...
class ProductItemModel {
  ...
  ProductItemModel({
    ...
    this.description = "design suitable for daily use, whether at home, work, or on the go. Perfect choice for customers who value style, reliability, and functionality. Please note that this is only a sample description used for testing the UI layout.",
    required this.price,
    this.isFav = false,
...
List<ProductItemModel> dummyProducts = [
  ProductItemModel(
    ...
    name: 'Grey Shoes',
    imgUrl:
        'https://i.pinimg.com/1200x/4c/da/13/4cda13b0453d475b9baf037b9ca21f91.jpg',
    price: 20,
    category: 'Shoes',
  ),
  ProductItemModel(
    ...
    name: 'White Shoes',
    imgUrl:
        'https://i.pinimg.com/1200x/5d/7f/a2/5d7fa28a015e80531835580dd9046a6c.jpg',
    price: 40,
    category: 'Shoes',
  ),
  ProductItemModel(
  ...
  ProductItemModel(
    ...
    name: 'Brown Hand Bag',
    imgUrl:
        'https://i.pinimg.com/1200x/87/bd/2e/87bd2ec357beb80374263240df471ba9.jpg',
    price: 10,
    category: 'Hand Bag',
  ),
  ProductItemModel(
    ...
    name: 'Black Nike Bag',
    imgUrl:
        'https://i.pinimg.com/1200x/b3/18/3c/b3183cc9433b0e7306458591c9c13171.jpg',
    price: 10,
    category: 'Back Bag',
  ),
  ProductItemModel(
    ...
    name: 'Blue Trousers',
    imgUrl:
        'https://i.pinimg.com/1200x/b4/79/2b/b4792b7a4c09f985cb39898815961422.jpg',
    price: 10,
    category: 'Trousers',
  ),
  ProductItemModel(
  ...
  ProductItemModel(
    ...
    imgUrl:
        'https://i.pinimg.com/1200x/d2/62/42/d26242a6b554b9a90d747228c2fc6af8.jpg',
    price: 10,
    category: 'Jacket',
  ),
  ProductItemModel(
