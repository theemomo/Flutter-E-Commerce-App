...
class FirestoreServices {
  ...
  Future<void> setData({
    required String
    path, // Collection/$documentId... -> Collection/$documentId/Collection/$documentId (have to be even number)
  ...
  Future<List<T>> getCollection<T>({
    required String path, // users/$userId/products (have to be odd number)
    required T Function(Map<String, dynamic> data, String documentId) builder,
